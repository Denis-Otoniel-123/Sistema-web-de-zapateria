...
//		label.setBackground(utils.Library.Claro_1);
		...
		lblNewLabel_2.setIcon(new ImageIcon(Pnl_Content.class.getResource("")));// quite el logo en el panel principal.
		...
		lblPaledotgmailcom = new JLabel("Dmoralesg15@gmail.com");
		...
		lblPaledot = new JLabel("Dmorales");
